...
class HomeScreenState extends State<HomeScreen> {
  ...
  /// The critique text generated by the model.
  ...
  Future<void> _generateImage() async {
    ...
    try {
      ...
      if (!mounted) return;
      _showErrorDialog('Error Generating Image', _getFriendlyErrorMessage(e));
    } finally {
  ...
  /// Generates a critique of the generated images using the Gemini model.
            ...
            TextButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => GalleryScreen(toggleTheme: widget.toggleTheme),
                  ),
                );
              },
              child: Text(
